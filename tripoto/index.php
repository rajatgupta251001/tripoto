		  ...
		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						<h4 style="color:#09F">Tripoto Enterprises</h4>
						<p style="color:#000">NEED HELP BOOKING PACKAGE<br/>
                        For fantastic suggestions you may also call our travel expert</p>
						<h5 style="color:#000"><span class="img1"></span>(+91) 8439192058&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;(+91) 7906098968</h5>
						<h5 style="color:#000"><span class="img2"></span><a href="#">info[at]tripoto.com&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;support[at]tripoto.com</a></h5>
						<h5 style="color:#000"><span class="img3"></span>Ghaziabad.</h5>
                        <br/>
